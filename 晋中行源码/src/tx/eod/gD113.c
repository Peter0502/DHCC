...
gD113()
{
	...
	/* 汇总借方发生额 */
	ret = sql_sum_double("dc_log", "amt", &c_bal, "acc_hrt='407A0' \
		and dc_ind='1' and sts='0'");
	if (ret != 0)
	{
	...
	ret = sql_sum_double("dc_log", "amt", &d_bal, "acc_hrt='407A0' \
		and dc_ind='2' and sts='0'");
	if (ret != 0)
	{
