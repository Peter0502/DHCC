...
* 修 改 人:
* 修改内容:
* insert into com_eod_exec values(9008,'7778','gDX08','贷款本金到期前1个月','1111111111','0','0','00','00','2','Y','Y','N','2','Y');
*************************************************/
...
gDX08()
{
	...
	while (1)
	{
		...
		pub_base_deadlineM(sCom_sys_parm.lst_date,1,&note_day);
		...
		while (1)
		{
			...
			pub_mob_sendmail_ln("***","7778",pact_no_tmp,"1",0.00,0.00,0.00);	
		}
