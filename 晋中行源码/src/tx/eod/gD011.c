...
* 注：
*		M004_fz		发展再贷款 余额
*		M004_tc		头寸(短期)再贷款 余额
*		M004_fz1	发展再贷款 本年累计发生额
*		M004_tc1	头寸(短期)再贷款 本年累计发生额
*
* 修改记录：
* 日    期:
* 修 改 人:
...
/*存款部分 不统计产品135的*/
		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and prdt_no not in ('135','142')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and prdt_no not in ('135','142')", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal = _dd_bal + _td_bal;
		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "cal_code='%s' and prdt_no in ('142')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "cal_code='%s' and prdt_no in ('142')", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal = sGlOprtDyn.cr_de_bal + _dd_bal + _td_bal;
		vtcp_log( "本日存款余额[%lf]", sGlOprtDyn.cr_de_bal );

		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and cal_code='1' and prdt_no not in ('135','136','131','142','138','139')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and cal_code='1' and prdt_no not in ('135','136','131','142','138','139')", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal1 = _dd_bal + _td_bal;
		vtcp_log( "本日个人存款余额[%lf]", sGlOprtDyn.cr_de_bal1 );

		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and cal_code='2' and prdt_no not in ('135','136','131','142','138','139')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and cal_code='2' and prdt_no not in ('135','136','131','142','138','139')", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal2 = _dd_bal + _td_bal;
		vtcp_log( "本日公司存款余额[%lf]", sGlOprtDyn.cr_de_bal2 );

		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and cal_code='3' and prdt_no not in ('135','136','131','142','138','139')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and cal_code='3' and prdt_no not in ('135','136','131','142','138','139')", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal3 = _dd_bal + _td_bal;
		vtcp_log( "本日机构、事业法人存款余额[%lf]", sGlOprtDyn.cr_de_bal3 );

		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and prdt_no='136'", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and prdt_no='136'", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal4 = _dd_bal + _td_bal;
		vtcp_log( "本日同业一般存款余额[%lf]", sGlOprtDyn.cr_de_bal4 );

		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and prdt_no in ('131')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and prdt_no in ('131')", sComBranch.br_no );
		MYSQLERR
		...
		g_reply_int = sql_sum_double( "dd_mst", "bal", &_dd_bal, "opn_br_no='%s' and prdt_no in ('138','139')", sComBranch.br_no );
		MYSQLERR
		g_reply_int = sql_sum_double( "td_mst", "bal", &_td_bal, "opn_br_no='%s' and prdt_no in ('138','139')", sComBranch.br_no );
		MYSQLERR
		sGlOprtDyn.cr_de_bal6 = _dd_bal + _td_bal;
		vtcp_log( "本日临时存款余额[%lf]", sGlOprtDyn.cr_de_bal6 );

/*贷款部分*/
		g_reply_int = sql_sum_double( "ln_mst", "bal", &sGlOprtDyn.cr_ln_bal, "opn_br_no='%s'", sComBranch.br_no );
		MYSQLERR
		vtcp_log( "本日贷款余额[%lf]", sGlOprtDyn.cr_ln_bal );

		g_reply_int = sql_sum_double( "ln_mst", "bal", &sGlOprtDyn.cr_ln_bal1, "opn_br_no='%s' and cal_code='1' and prdt_no not in ('3Z1','3Z2')", sComBranch.br_no );
		MYSQLERR
		vtcp_log( "本日个人贷款余额[%lf]", sGlOprtDyn.cr_ln_bal1 );

		g_reply_int = sql_sum_double( "ln_mst", "bal", &sGlOprtDyn.cr_ln_bal2, "opn_br_no='%s' and cal_code='2' and prdt_no not in ('3Z1','3Z2')", sComBranch.br_no );
		MYSQLERR
		vtcp_log( "本日公司贷款余额[%lf]", sGlOprtDyn.cr_ln_bal2 );

		g_reply_int = sql_sum_double( "ln_mst", "bal", &sGlOprtDyn.cr_ln_bal3, "opn_br_no='%s' and cal_code='3' and prdt_no not in ('3Z1','3Z2')", sComBranch.br_no );
		MYSQLERR
		vtcp_log( "本日机构、事业法人贷款余额[%lf]", sGlOprtDyn.cr_ln_bal3 );

		g_reply_int = sql_sum_double( "ln_mst", "bal", &sGlOprtDyn.cr_ln_bal4, "opn_br_no='%s' and prdt_no in ('3Z1','3Z2')", sComBranch.br_no );
		MYSQLERR
