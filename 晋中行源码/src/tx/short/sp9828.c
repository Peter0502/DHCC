...
{ 		
	...
	if( g_ln_mst.ac_sts[0] =='2' || g_ln_mst.ac_sts[0] =='3' ||g_ln_mst.ac_sts[0] =='4')
	{
	 	flag[0]='3';	/* 逾期 */
	}	 
	 ret = pub_ln_lndis_file(ac_no,ac_seqn,&g_mdm_ac_rel,&g_ln_mst,&g_ln_parm ); /*读取贷款户信息*/
	if( ret ) 
	{
