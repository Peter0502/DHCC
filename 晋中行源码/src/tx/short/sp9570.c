...
sp9570()
{
	...
	sprintf(cTmplist,"br_no = '%s' and wt_date =%s and  packid is null  and  (lv_sts='3' or (pkgno in('002','006') and lv_sts='1')) and lw_ind='1'  ");
	
	ret = Lv_pkgreg_Dec_Sel(g_pub_tx.reply, cTmplist,cBr_no,cPack_date);
	if(ret)
	{
