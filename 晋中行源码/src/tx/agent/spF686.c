/*************************************************
* ÎÄ ¼ş Ãû: spF686.c--spF610.cĞŞ¸Ä
* ¹¦ÄÜÃèÊö£ºÅúÁ¿¿ª»§½»Ò×-ÉñÂë
*
* ×÷    Õß: jack
...
insert into tx_def values ('6686','ÉñÂëÅúÁ¿¿ª¿¨Éú³ÉÎÄ¼ş','10000000000000000000000001000000000000010001110000000000000000000010110000000000000000000010000000000000000000000000010000000000','1','4','0','3','');
insert into tx_flow_def values ('6686','0','6686','#$');
insert into tx_sub_def values ('6686','ÉñÂëÅúÁ¿¿ª¿¨Éú³ÉÎÄ¼ş','spF686','0','0');
...
¿¨ºÅ|¿Í»§ºÅ|³Ö¿¨ÈËÖ¤¼şÖÖÀà|³Ö¿¨ÈËÖ¤¼şºÅÂë|³Ö¿¨ÈË¿Í»§Ãû|³Ö¿¨ÈË¿Í»§Ó¢ÎÄÃû|³Ö¿¨ÈËĞÔ±ğ|³Ö¿¨ÈË¼ÒÍ¥×¡Ö·|³Ö¿¨ÈË¼ÒÍ¥ÓÊ±à|³Ö¿¨ÈË¼ÒÍ¥µç»°|³Ö¿¨ÈËµ¥Î»Ãû³Æ|³Ö¿¨ÈËµ¥Î»µØÖ·|³Ö¿¨ÈËµ¥Î»ÓÊ±à|³Ö¿¨ÈËµ¥Î»µç»°|³Ö¿¨ÈËÊÖ»úºÅÂë|³Ö¿¨ÈËÓÊÏä|³Ö¿¨ÈËĞÅÓşµÈ¼¶|ÔÂÊÕÈë|³öÉúÈÕÆÚ|»éÒö×´¿ö|´úÀíµ¥Î»±àºÅ|¸öÈË´úÀí±àºÅ|¿ª»§½ğ¶î|
	**/
	...
	if ( !strcmp(cNote_type, "020") || !strcmp(cNote_type, "024") ) /* ¿¨ $IC¿¨*/
	{
		strcpy( cRctp, "¿¨" );
	...
	if ( strcmp( cNote_type, "020" ) == 0 )		/**¿¨½éÖÊĞèÒªÏÂÆ¾Ö¤**/
	{
