...
insert into TX_DEF values ('7020', '活期帐户信息查询', '11000000000010010001000011100110000110111101010000000010000011100111111110010000111000001110101001000000000000000000000000000100', '1', '5', '2');
insert into TX_FLOW_DEF values ('7020', 0, '7020', '#=0000@1@#$');
insert into TX_FLOW_DEF values ('7020', 1, 'F000', '#$');
insert into TX_SUB_DEF values ('7020', '活期账户信息查询', 'sp7020', '0', '0');
*************************************************/
#include <stdio.h>
#include "public.h"
#include "dd_mst_c.h"
