...
insert into tx_def  values ('6234', '联机单笔转账记账', '10000000000000000000000000000100000000010000000000000000000001000101111000000000100000000000000000000000000000000000000000000000', '1', '1', '0', '3', null);
insert into tx_flow_def  values ('6234', 0, '6234', '#=0000@1@#$');
insert into tx_flow_def  values ('6234', 1, 'HPDF', '#=0000@2@#$');
insert into tx_flow_def  values ('6234', 2, 'NULL', '#=0001@3@#=0002@4@#=0003@5@#=0004@6@#$');
insert into tx_flow_def  values ('6234', 3, 'D003', '#=0000@7@#$');
insert into tx_flow_def  values ('6234', 4, 'D099', '#=0000@7@#$');
insert into tx_flow_def  values ('6234', 5, 'A016', '#=0000@7@#$');
insert into tx_flow_def  values ('6234', 6, 'A017', '#=0000@7@#$');
insert into tx_flow_def  values ('6234', 7, 'F000', '#$');

insert into tx_sub_def  values ('6234', '联机单笔转账记账交易', 'sp6234', '0', '0');

insert into tx_sub_rel  values ('6234', 'HPDF', '0', '0660', '0720', '借贷标志');
insert into tx_sub_rel  values ('6234', 'HPDF', '1', '01', '0210', '币种');
insert into tx_sub_rel  values ('6234', 'HPDF', '0', '0300', '0300', '账号');
insert into tx_sub_rel  values ('6234', 'HPDF', '1', '2', '0670', '现转标志');
insert into tx_sub_rel  values ('6234', 'HPDF', '0', '0400', '0400', '金额');
insert into tx_sub_rel  values ('6234', 'HPDF', '0', '0810', '0880', '摘要');
insert into tx_sub_rel  values ('6234', 'HPDF', '0', '0890', '0890','凭证种类');
insert into tx_sub_rel  values ('6234', 'HPDF', '0', '0590', '0580','凭证号码');

insert into tx_sub_rel  values ('6234', 'NULL', '0', '0700', '0120','配置分支');

insert into tx_sub_rel  values ('6234', 'D003', '0', '0310', '1021', '账号');
insert into tx_sub_rel  values ('6234', 'D003', '1', '0000', '0192', '控制标志');
insert into tx_sub_rel  values ('6234', 'D003', '1', '1001', '0193', '普通存取');
insert into tx_sub_rel  values ('6234', 'D003', '1', '1', '0191', '控制标志');
insert into tx_sub_rel  values ('6234', 'D003', '1', '1', '1022', '账户序号');
insert into tx_sub_rel  values ('6234', 'D003', '0', '0400', '102F', '金额');
insert into tx_sub_rel  values ('6234', 'D003', '1', '01', '102J', '币种');
insert into tx_sub_rel  values ('6234', 'D003', '1', '2', '102K', '现转标志');
insert into tx_sub_rel  values ('6234', 'D003', '0', '0810', '102Y', '摘要');

insert into tx_sub_rel  values ('6234', 'D099', '0', '0310', '1011', '账号');
insert into tx_sub_rel  values ('6234', 'D099', '1', '01', '101A', '币种');
insert into tx_sub_rel  values ('6234', 'D099', '1', '2', '101B', '现转');
insert into tx_sub_rel  values ('6234', 'D099', '1', '0000', '0192', '控制标志');
insert into tx_sub_rel  values ('6234', 'D099', '1', '1001', '0193', '普通存取');
insert into tx_sub_rel  values ('6234', 'D099', '1', '1', '0191', '控制标志');
insert into tx_sub_rel  values ('6234', 'D099', '0', '0810', '1016', '摘要');
insert into tx_sub_rel  values ('6234', 'D099', '1', '1', '1012', '序号');
insert into tx_sub_rel  values ('6234', 'D099', '0', '0400', '1013', '金额');

insert into tx_sub_rel  values ('6234', 'A016', '0', '0310', '1201', '账号');
insert into tx_sub_rel  values ('6234', 'A016', '1', '01', '1204', '币种');
insert into tx_sub_rel  values ('6234', 'A016', '1', '2', '1205', '转账');
insert into tx_sub_rel  values ('6234', 'A016', '0', '0400', '1208', '金额');
insert into tx_sub_rel  values ('6234', 'A016', '0', '0810', '120A', '摘要');

insert into tx_sub_rel  values ('6234', 'A017', '0', '0310', '1211', '账号');
insert into tx_sub_rel  values ('6234', 'A017', '1', '2', '1215', '现转标志');
insert into tx_sub_rel  values ('6234', 'A017', '0', '0400', '1218', '金额');
insert into tx_sub_rel  values ('6234', 'A017', '0', '0810', '121A', '摘要');
insert into tx_sub_rel  values ('6234', 'A017', '1', '01', '1214', '币种');
...
int sp6234()
{
    ...
    **/
    ...
    else if( cFee_flag[0] == '1' || cFee_flag[0] == '2')
    {
         ...
         vtcp_log("[%s][%d],dFee_amt=[%lf]",__FILE__,__LINE__,dFee_amt);
         sChnl_single_acct.fee_amt=dFee_amt;      /*手续费金额*/             
    }
    ...
    if( strlen ( cAc_no1 ) >10) /*** 此种情况下,只能是账号 ***/
    {
        ...
        if(sPrdt_ac_id.ac_id_type[0] == '1')
        {
            ...
            if(cDc_ind[0] == '1')   /*1-借*/
            {
                ...
                /*6234不检查余额 fupengfei 2014/7/10 15:46:26*/
    ...
    {        /**** 否则是科目  **/
        ...
        if(iRet)
        {
            sprintf(acErrMsg,"查询科目失败!!! acc_no=[%s] ret=[%d]", cAc_no2, iRet);
            WRITEMSG
            strcpy(g_pub_tx.reply, "B172");
            goto ErrExit;
        }
