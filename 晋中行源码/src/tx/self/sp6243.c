...
insert into tx_def  values ('6243', '联机单笔现金记账', '10000000000000000000000000000100000000010000000000000000000001000100000000000000100000000000000000000000000000000000000000000000', '1', '1', '0', '3', null);
insert into tx_flow_def  values ('6243', 0, '6243', '#=0001@1@#=0002@3@#=0003@5@#=0004@6@#$');
insert into tx_flow_def  values ('6243', 1, 'D003', '#=0000@2@#$');
insert into tx_flow_def  values ('6243', 2, 'M002', '#=0000@7@#$');
insert into tx_flow_def  values ('6243', 3, 'D099', '#=0000@4@#$');
insert into tx_flow_def  values ('6243', 4, 'M001', '#=0000@7@#$');
insert into tx_flow_def  values ('6243', 5, 'A016', '#=0000@2@#$');
insert into tx_flow_def  values ('6243', 6, 'A017', '#=0000@4@#$');
insert into tx_flow_def  values ('6243', 7, 'F000', '#$');
insert into tx_sub_def  values ('6243', '联机单笔现金记账交易', 'sp6243', '0', '0');

insert into TX_SUB_REL  values ('6243', 'A016', '0', '0300', '1201', '账号');
insert into TX_SUB_REL  values ('6243', 'A016', '1', '01', '1204', '币种');
insert into TX_SUB_REL  values ('6243', 'A016', '1', '1', '1205', '转账');
insert into TX_SUB_REL  values ('6243', 'A016', '0', '0400', '1208', '金额');
insert into TX_SUB_REL  values ('6243', 'A016', '0', '0810', '120A', '摘要');
insert into TX_SUB_REL  values ('6243', 'A017', '0', '0300', '1211', '账号');
insert into TX_SUB_REL  values ('6243', 'A017', '1', '1', '1215', '现转标志');
insert into TX_SUB_REL  values ('6243', 'A017', '0', '0400', '1218', '金额');
insert into TX_SUB_REL  values ('6243', 'A017', '0', '0810', '121A', '摘要');
insert into TX_SUB_REL  values ('6243', 'A017', '1', '01', '1214', '币种');
insert into TX_SUB_REL  values ('6243', 'D003', '0', '0300', '1021', '账号');
insert into TX_SUB_REL  values ('6243', 'D003', '1', '0000', '0192', '控制标志');
insert into TX_SUB_REL  values ('6243', 'D003', '1', '1', '0191', '控制标志');
insert into TX_SUB_REL  values ('6243', 'D003', '1', '1', '1022', '账号');
insert into TX_SUB_REL  values ('6243', 'D003', '0', '0400', '102F', '金额');
insert into TX_SUB_REL  values ('6243', 'D003', '1', '01', '102J', '币种');
insert into TX_SUB_REL  values ('6243', 'D003', '1', '1', '102K', '现转标志');
insert into TX_SUB_REL  values ('6243', 'D003', '0', '0810', '102Y', '摘要');
insert into TX_SUB_REL  values ('6243', 'D099', '0', '0300', '1011', '账号');
insert into TX_SUB_REL  values ('6243', 'D099', '1', '01', '101A', '币种');
insert into TX_SUB_REL  values ('6243', 'D099', '1', '1', '101B', '现转');
insert into TX_SUB_REL  values ('6243', 'D099', '1', '0000', '0192', '控制标志');
insert into TX_SUB_REL  values ('6243', 'D099', '1', '1', '0191', '控制标志');
insert into TX_SUB_REL  values ('6243', 'D099', '0', '0810', '1016', '摘要');
insert into TX_SUB_REL  values ('6243', 'D099', '1', '1', '1012', '序号');
insert into TX_SUB_REL  values ('6243', 'D099', '0', '0400', '1013', '金额');
insert into TX_SUB_REL  values ('6243', 'M001', '0', '0400', '1184', '金额');
insert into TX_SUB_REL  values ('6243', 'M001', '0', '0300', '1188', '对方账号');
insert into TX_SUB_REL  values ('6243', 'M001', '1', '01', '1181', '对方账号');
insert into TX_SUB_REL  values ('6243', 'M001', '0', '0810', '1187', '摘要');
insert into TX_SUB_REL  values ('6243', 'M002', '0', '0400', '1194', '金额');
insert into TX_SUB_REL  values ('6243', 'M002', '1', '01', '1191', '币种');
insert into TX_SUB_REL  values ('6243', 'M002', '0', '0810', '1197', '摘要');
insert into TX_SUB_REL  values ('6243', 'M002', '0', '0300', '1198', '对方账号');
...
int sp6243()
{
  ...
  **/
  ...
  vtcp_log("%s,%d,startsp6243",__FILE__,__LINE__);
  
  if( cCk_flag[0] == '1' )  /*存款确认*/
  {
     sprintf(cPt_trace,"%d",lPt_trace_no); /*平台流水由long转char*/ 
     iRet=Chnl_single_cnaps_Sel(g_pub_tx.reply,&stChnlCnaps,"pt_date=%ld and pt_trace_no='%s' and sts='1'",lPt_date,cPt_trace);
     if( iRet == 0)
     {
          /*已经记账成功*/
          sprintf(acErrMsg,"%s,%d,重复交易",__FILE__,__LINE__);
  ...
  if (strlen (g_pub_tx.ac_no) >10) /*** 此种情况下,只能是账号 ***/
  {
        ...
        else if( sPrdt_ac_id.ac_id_type[0] == '9')
        {
            ...
            iRet=pub_com_test(cCtrlcmd,cCert_no,cAc_name,cAc_no,cNote_type,cNote_no,"2",cGz_flag);
            vtcp_log("%s,%d,cCtrlcmd=[%s],cCert_no=[%s],cAc_name=[%s],cAc_no=[%s],cGz_flag=[%s]",__FILE__,__LINE__,cCtrlcmd,cCert_no,cAc_name,cAc_no,cGz_flag);
            if (iRet)
            {
                sprintf(acErrMsg,"%s,%d,公共函数pub_com_test()调用失败",__FILE__,__LINE__);
  ...
  {/**** 否则是科目  **/
      ...
      if(iRet)
      {
       ...
       /*73域控制标志检查 del by chenhw 20120905 科目验什么73域阿 
      iRet=pub_com_test(cCtrlcmd,cCert_no,cAc_name,cAc_no,"","","2",cGz_flag);
      vtcp_log("%s,%d,cCtrlcmd=[%s],cCert_no=[%s],cAc_name=[%s],cAc_no=[%s],cGz_flag=[%s]",__FILE__,__LINE__,cCtrlcmd,cCert_no,cAc_name,cAc_no,cGz_flag);
      if (iRet)
       {
   ...
   /*stChnlCnaps.trace_no = g_pub_tx.ejfno;  * 核心流水  登记的流水号不是柜员流水号，而是核心的交易流水号 MOD BY CHENGBO 20110727*/
   stChnlCnaps.trace_no=g_pub_tx.trace_no;
   memcpy(stChnlCnaps.cur_no,"01",2); /**  暂时写死为01人民币 ***/
   /*if (strlen(cDc_entry)>0)
	{
   		 memcpy(stChnlCnaps.ac_no, "9100200000288",sizeof( stChnlCnaps.ac_no)-1); 
   	}else*/{
   ...
   memcpy(stChnlCnaps.opn_br_no,g_pub_tx.opn_br_no,sizeof(stChnlCnaps.opn_br_no)-1);  /** 开户机构 **/
