...
insert into tx_def  values ('6254', '联机单笔冲正', '10000000000000000000000000000100000000010000000000000000000001000100000000000000100000000000000000000000000000000000000000000000', '1', '1', '0');

insert into tx_flow_def  values ('6254', 0, '6254', '#=0001@1@#=0002@7@#=0003@3@#=0004@8@#=0005@5@#=0006@9@#=0007@6@#=0008@10@#$');
insert into tx_flow_def  values ('6254', 1, 'D003', '#=0000@2@#$');
insert into tx_flow_def  values ('6254', 2, 'M002', '#=0000@17@#$');
insert into tx_flow_def  values ('6254', 3, 'D099', '#=0000@4@#$');
insert into tx_flow_def  values ('6254', 4, 'M001', '#=0000@17@#$');
insert into tx_flow_def  values ('6254', 5, 'A016', '#=0000@2@#$');
insert into tx_flow_def  values ('6254', 6, 'A017', '#=0000@4@#$');
insert into tx_flow_def  values ('6254', 7, 'D003', '#=0000@11@#$');
insert into tx_flow_def  values ('6254', 8, 'D099', '#=0000@11@#$');
insert into tx_flow_def  values ('6254', 9, 'A016', '#=0000@11@#$');
insert into tx_flow_def  values ('6254', 10, 'A017', '#=0000@11@#$');
insert into tx_flow_def  values ('6254', 11, 'NULL', '#=0006@13@#=0007@12@#=0008@15@#=0009@14@#$');
insert into tx_flow_def  values ('6254', 12, 'D003', '#=0000@16@#$');
insert into tx_flow_def  values ('6254', 13, 'D099', '#=0000@16@#$');
insert into tx_flow_def  values ('6254', 14, 'A016', '#=0000@16@#$');
insert into tx_flow_def  values ('6254', 15, 'A017', '#=0000@16@#$');
insert into tx_flow_def  values ('6254', 16, 'F059', '#=0000@17@#$');
insert into tx_flow_def  values ('6254', 17, 'F000', '#$');

insert into tx_sub_rel  values ('6254', 'NULL', '0', '0700', '0120','配置分支');

insert into tx_sub_rel  values ('6254', 'A016', '1', '01', '1204', '币种');
insert into tx_sub_rel  values ('6254', 'A016', '0', '0680', '1205', '转账');
insert into tx_sub_rel  values ('6254', 'A016', '0', '0810', '120A', '摘要');

insert into tx_sub_rel  values ('6254', 'A017', '0', '0680', '1215', '现转标志');
insert into tx_sub_rel  values ('6254', 'A017', '0', '0810', '121A', '摘要');
insert into tx_sub_rel  values ('6254', 'A017', '1', '01', '1214', '币种');

insert into tx_sub_rel  values ('6254', 'D003', '1', '0000', '0192', '控制标志');
insert into tx_sub_rel  values ('6254', 'D003', '1', '1', '0191', '控制标志');
insert into tx_sub_rel  values ('6254', 'D003', '1', '1001', '0193', '控制标志');
insert into tx_sub_rel  values ('6254', 'D003', '1', '1', '1022', '账户序号');
insert into tx_sub_rel  values ('6254', 'D003', '1', '01', '102J', '币种');
insert into tx_sub_rel  values ('6254', 'D003', '0', '0680', '102K', '现转标志');
insert into tx_sub_rel  values ('6254', 'D003', '0', '0810', '102Y', '摘要');

insert into tx_sub_rel  values ('6254', 'D099', '1', '01', '101A', '币种');
insert into tx_sub_rel  values ('6254', 'D099', '0', '0680', '101B', '现转');
insert into tx_sub_rel  values ('6254', 'D099', '1', '0000', '0192', '控制标志');
insert into tx_sub_rel  values ('6254', 'D099', '1', '1', '0191', '控制标志');
insert into tx_sub_rel  values ('6254', 'D099', '1', '1001', '0193', '普通存取');
insert into tx_sub_rel  values ('6254', 'D099', '0', '0810', '1016', '摘要');
insert into tx_sub_rel  values ('6254', 'D099', '1', '1', '1012', '序号');

insert into tx_sub_rel  values ('6254', 'M001', '0', '0300', '1188', '对方账号');
insert into tx_sub_rel  values ('6254', 'M001', '1', '01', '1181', '币种');
insert into tx_sub_rel  values ('6254', 'M001', '0', '0810', '1187', '摘要');

insert into tx_sub_rel  values ('6254', 'M002', '1', '01', '1191', '币种');
insert into tx_sub_rel  values ('6254', 'M002', '0', '0810', '1197', '摘要');
insert into tx_sub_rel  values ('6254', 'M002', '0', '0300', '1198', '对方账号');

insert into tx_sub_def   values ('6254', '联机单笔冲正', 'sp6254', '0', '0');
******************************************************************/
...
sp6254()
{
    ...
    memset(&sChnl_single_acct,0,sizeof(struct chnl_single_acct_c));
    ...
    iRet=Chnl_single_acct_Sel(g_pub_tx.reply,&sChnl_single_acct,"pt_date=%ld and pt_trace_no='%s'",lPt_old_date,cPt_old_trace);
    Modefied by YangMeng 2014/7/18 9:51:36 修改查询条件**/
    
    if ( sys73[9] == '3' ) /**二代特有的选择项 Modefied by liuzengying 2014/7/18 10:54:46 修改查询条件**/
    {
			iRet=Chnl_single_acct_Sel(g_pub_tx.reply,&sChnl_single_acct,"chnl_type='%c' and bbmk = '%s' and pt_date=%ld and pt_trace_no='%s'",sys73[9], cBbmk, lPt_old_date, cPt_old_trace);
		}
		else
		{
			iRet=Chnl_single_acct_Sel(g_pub_tx.reply,&sChnl_single_acct,"bbmk = '%s' and pt_date=%ld and pt_trace_no='%s'", cBbmk, lPt_old_date, cPt_old_trace);
		}
    ...
    if (sChnl_single_acct.sts[0] == '4')  /*4-已做冲正*/
    {
    ...
    if (sChnl_single_acct.sts[0] == '0')  /*0-交易无效*/
    {
    ...
    vtcp_log("[%s][%d],sChnl_single_acct.ac_no=[%s]",__FILE__,__LINE__,sChnl_single_acct.ac_no);
    vtcp_log("[%s][%d],cHx_ac_no=[%s]",__FILE__,__LINE__,cHx_ac_no);
    /*
        if (strcmp(sChnl_single_acct.ac_no,cHx_ac_no) != 0)
        {
    ...
    if (pub_base_CompDblVal(sChnl_single_acct.tx_amt,dHx_amt) !=0 )
    {
        strcpy(g_pub_tx.reply, "YY02");
        sprintf(acErrMsg, "冲正金额与原金额不符!");
        WRITEMSG
        vtcp_log("[%s][%d],sChnl_single_acct.tx_amt=[%lf] dHx_amt=[%lf]",__FILE__,__LINE__,sChnl_single_acct.tx_amt,dHx_amt);
        goto ErrExit;
    }
    /*判断收费金额是否正确    开始*/
    ...
    vtcp_log("[%s][%d],sChnl_single_acct.fee_amt=[%lf]",__FILE__,__LINE__,sChnl_single_acct.fee_amt);
    if (pub_base_CompDblVal(sChnl_single_acct.fee_amt,dCif_fee) !=0 )
    {
    ...
    zip_space(cHx_ac_no);
    zip_space(sChnl_single_acct.ac_no2);
    ...
    if(strlen(cHx_ac_no) > 10)   /**账号*/
    {
         ...
         if (iRet)
         {
              vtcp_log("%s,%d,ac_no[%s]查询prdt_ac_rel错误!",__FILE__,__LINE__,sChnl_single_acct.ac_no1);
    ...
    /*开始更新单笔记账登记簿（chnl_single_acct）*/
    
     memset(&sChnl_single_acct,0,sizeof(struct chnl_single_acct_c));
     /**增加bbmk 字段 shangyongchao 2012/6/7 11:17:07
     iRet=Chnl_single_acct_Dec_Upd(g_pub_tx.reply," pt_date = %ld and pt_trace_no= '%s'",lPt_old_date,cPt_old_trace);
     **/
     iRet=Chnl_single_acct_Dec_Upd(g_pub_tx.reply," pt_date = %ld and pt_trace_no= '%s' and bbmk='%s'",\
        lPt_old_date,cPt_old_trace,cBbmk);
     if (iRet) 
     {
         sprintf(acErrMsg, "执行Chnl_single_acct_Dec_Upd错[%d]", iRet);
         WRITEMSG
         goto ErrExit;
     }
     
     
     iRet = Chnl_single_acct_Fet_Upd(&sChnl_single_acct,g_pub_tx.reply);
     if (iRet) 
     {
         sprintf(acErrMsg, "执行Chnl_single_acct_Fet_Upd 错[%d]", iRet);
         WRITEMSG
         goto ErrExit;
     }
     sChnl_single_acct.sts[0]='4'; /*
                                     0:交易无效(不参与对账)
                                     1:记账成功(参与对账)
                                     2：挂帐成功(参与对账)
                                     3：挂后入账成功(参与对账)
                                     ...
                                     5：退回成功(参与对账)
                                   */
     /*sChnl_single_acct.o_pt_date=lPt_cz_date;   平台日期
     sprintf(cO_pt_trace_no,"%12ld",lPt_cz_trace);
     strcpy(sChnl_single_acct.o_pt_trace_no,cO_pt_trace_no); 平台流水*/
     iRet=Chnl_single_acct_Upd_Upd(sChnl_single_acct,g_pub_tx.reply);
     if (iRet)
     {
     ...
     if(cCz_flag[0] == '1')
     {
        ...
        iRet = sql_execute("update chnl_single_acct set sts ='1' where pt_date =%ld and pt_trace_no ='%s'",\
        sChnl_single_acct.o_pt_date,sChnl_single_acct.o_pt_trace_no);
        **/
        iRet = sql_execute("update chnl_single_acct set sts ='1' where pt_date =%ld and pt_trace_no ='%s' and bbmk='%s'",\
        sChnl_single_acct.o_pt_date,sChnl_single_acct.o_pt_trace_no,sChnl_single_acct.bbmk);
        if(iRet)
        {
            sprintf(acErrMsg, "修改单笔记账登记簿错误![%d]",iRet);
            WRITEMSG
