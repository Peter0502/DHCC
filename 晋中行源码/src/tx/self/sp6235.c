...
insert into tx_def  values ('6235', '联机单笔冲正', '10000000000000000000000000000100000000010000000000000000000001000100000000000000100000000000000000000000000000000000000000000000', '1', '1', '0', '3', null);

insert into tx_flow_def  values ('6235', 0, '6235', '#=0001@1@#=0002@7@#=0003@3@#=0004@8@#=0005@5@#=0006@9@#=0007@6@#=0008@10@#$');
insert into tx_flow_def  values ('6235', 1, 'D003', '#=0000@2@#$');
insert into tx_flow_def  values ('6235', 2, 'M002', '#=0000@17@#$');
insert into tx_flow_def  values ('6235', 3, 'D099', '#=0000@4@#$');
insert into tx_flow_def  values ('6235', 4, 'M001', '#=0000@17@#$');
insert into tx_flow_def  values ('6235', 5, 'A016', '#=0000@2@#$');
insert into tx_flow_def  values ('6235', 6, 'A017', '#=0000@4@#$');
insert into tx_flow_def  values ('6235', 7, 'D003', '#=0000@11@#$');
insert into tx_flow_def  values ('6235', 8, 'D099', '#=0000@11@#$');
insert into tx_flow_def  values ('6235', 9, 'A016', '#=0000@11@#$');
insert into tx_flow_def  values ('6235', 10, 'A017', '#=0000@11@#$');
insert into tx_flow_def  values ('6235', 11, 'NULL', '#=0006@13@#=0007@12@#=0008@15@#=0009@14@#$');
insert into tx_flow_def  values ('6235', 12, 'D003', '#=0000@17@#$');
insert into tx_flow_def  values ('6235', 13, 'D099', '#=0000@17@#$');
insert into tx_flow_def  values ('6235', 14, 'A016', '#=0000@17@#$');
insert into tx_flow_def  values ('6235', 15, 'A017', '#=0000@17@#$');
insert into tx_flow_def  values ('6235', 17, 'F000', '#$');

insert into tx_sub_rel  values ('6235', 'NULL', '0', '0700', '0120','配置分支');

insert into tx_sub_rel  values ('6235', 'A016', '1', '01', '1204', '币种');
insert into tx_sub_rel  values ('6235', 'A016', '0', '0680', '1205', '转账');
insert into tx_sub_rel  values ('6235', 'A016', '0', '0810', '120A', '摘要');

insert into tx_sub_rel  values ('6235', 'A017', '0', '0680', '1215', '现转标志');
insert into tx_sub_rel  values ('6235', 'A017', '0', '0810', '121A', '摘要');
insert into tx_sub_rel  values ('6235', 'A017', '1', '01', '1214', '币种');

insert into tx_sub_rel  values ('6235', 'D003', '1', '0000', '0192', '控制标志');
insert into tx_sub_rel  values ('6235', 'D003', '1', '1', '0191', '控制标志');
insert into tx_sub_rel  values ('6235', 'D003', '1', '1001', '0193', '控制标志');
insert into tx_sub_rel  values ('6235', 'D003', '1', '1', '1022', '账户序号');
insert into tx_sub_rel  values ('6235', 'D003', '1', '01', '102J', '币种');
insert into tx_sub_rel  values ('6235', 'D003', '0', '0680', '102K', '现转标志');
insert into tx_sub_rel  values ('6235', 'D003', '0', '0810', '102Y', '摘要');

insert into tx_sub_rel  values ('6235', 'D099', '1', '01', '101A', '币种');
insert into tx_sub_rel  values ('6235', 'D099', '0', '0680', '101B', '现转');
insert into tx_sub_rel  values ('6235', 'D099', '1', '0000', '0192', '控制标志');
insert into tx_sub_rel  values ('6235', 'D099', '1', '1', '0191', '控制标志');
insert into tx_sub_rel  values ('6235', 'D099', '1', '1001', '0193', '普通存取');
insert into tx_sub_rel  values ('6235', 'D099', '0', '0810', '1016', '摘要');
insert into tx_sub_rel  values ('6235', 'D099', '1', '1', '1012', '序号');

insert into tx_sub_rel  values ('6235', 'M001', '0', '0300', '1188', '对方账号');
insert into tx_sub_rel  values ('6235', 'M001', '1', '01', '1181', '币种');
insert into tx_sub_rel  values ('6235', 'M001', '0', '0810', '1187', '摘要');

insert into tx_sub_rel  values ('6235', 'M002', '1', '01', '1191', '币种');
insert into tx_sub_rel  values ('6235', 'M002', '0', '0810', '1197', '摘要');
insert into tx_sub_rel  values ('6235', 'M002', '0', '0300', '1198', '对方账号');

insert into tx_sub_def   values ('6235', '联机单笔冲正', 'sp6235', '0', '0');
******************************************************************/
