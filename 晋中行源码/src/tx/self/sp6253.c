...
*
insert into tx_def  values ('6253', '联机单笔现金记账', '10000000000000000000000000000100000000010000000000000000000001000100000000000000100000000000000000000000000000000000000000000000', '1', '1', '0');
insert into tx_flow_def  values ('6253', 0, '6253', '#=0001@1@#=0002@3@#=0003@5@#=0004@6@#$');
insert into tx_flow_def  values ('6253', 1, 'D003', '#=0000@2@#$');
insert into tx_flow_def  values ('6253', 2, 'M002', '#=0000@7@#$');
insert into tx_flow_def  values ('6253', 3, 'D099', '#=0000@4@#$');
insert into tx_flow_def  values ('6253', 4, 'M001', '#=0000@7@#$');
insert into tx_flow_def  values ('6253', 5, 'A016', '#=0000@2@#$');
insert into tx_flow_def  values ('6253', 6, 'A017', '#=0000@4@#$');
insert into tx_flow_def  values ('6253', 7, 'F059', '#=0000@8@#$');
insert into tx_flow_def  values ('6253', 8, 'F000', '#$');
insert into tx_sub_def  values ('6253', '联机单笔现金记账交易', 'sp6253', '0', '0');

insert into TX_SUB_REL  values ('6253', 'A016', '0', '0300', '1201', '账号');
insert into TX_SUB_REL  values ('6253', 'A016', '1', '01', '1204', '币种');
insert into TX_SUB_REL  values ('6253', 'A016', '1', '1', '1205', '转账');
insert into TX_SUB_REL  values ('6253', 'A016', '0', '0400', '1208', '金额');
insert into TX_SUB_REL  values ('6253', 'A016', '0', '0810', '120A', '摘要');
insert into TX_SUB_REL  values ('6253', 'A017', '0', '0300', '1211', '账号');
insert into TX_SUB_REL  values ('6253', 'A017', '1', '1', '1215', '现转标志');
insert into TX_SUB_REL  values ('6253', 'A017', '0', '0400', '1218', '金额');
insert into TX_SUB_REL  values ('6253', 'A017', '0', '0810', '121A', '摘要');
insert into TX_SUB_REL  values ('6253', 'A017', '1', '01', '1214', '币种');
insert into TX_SUB_REL  values ('6253', 'D003', '0', '0300', '1021', '账号');
insert into TX_SUB_REL  values ('6253', 'D003', '1', '0000', '0192', '控制标志');
insert into TX_SUB_REL  values ('6253', 'D003', '1', '1', '0191', '控制标志');
insert into TX_SUB_REL  values ('6253', 'D003', '1', '1', '1022', '账号');
insert into TX_SUB_REL  values ('6253', 'D003', '0', '0400', '102F', '金额');
insert into TX_SUB_REL  values ('6253', 'D003', '1', '01', '102J', '币种');
insert into TX_SUB_REL  values ('6253', 'D003', '1', '1', '102K', '现转标志');
insert into TX_SUB_REL  values ('6253', 'D003', '0', '0810', '102Y', '摘要');
insert into TX_SUB_REL  values ('6253', 'D099', '0', '0300', '1011', '账号');
insert into TX_SUB_REL  values ('6253', 'D099', '1', '01', '101A', '币种');
insert into TX_SUB_REL  values ('6253', 'D099', '1', '1', '101B', '现转');
insert into TX_SUB_REL  values ('6253', 'D099', '1', '0000', '0192', '控制标志');
insert into TX_SUB_REL  values ('6253', 'D099', '1', '1', '0191', '控制标志');
insert into TX_SUB_REL  values ('6253', 'D099', '0', '0810', '1016', '摘要');
insert into TX_SUB_REL  values ('6253', 'D099', '1', '1', '1012', '序号');
insert into TX_SUB_REL  values ('6253', 'D099', '0', '0400', '1013', '金额');
insert into TX_SUB_REL  values ('6253', 'M001', '0', '0400', '1184', '金额');
insert into TX_SUB_REL  values ('6253', 'M001', '0', '0300', '1188', '对方账号');
insert into TX_SUB_REL  values ('6253', 'M001', '1', '01', '1181', '对方账号');
insert into TX_SUB_REL  values ('6253', 'M001', '0', '0810', '1187', '摘要');
insert into TX_SUB_REL  values ('6253', 'M002', '0', '0400', '1194', '金额');
insert into TX_SUB_REL  values ('6253', 'M002', '1', '01', '1191', '币种');
insert into TX_SUB_REL  values ('6253', 'M002', '0', '0810', '1197', '摘要');
insert into TX_SUB_REL  values ('6253', 'M002', '0', '0300', '1198', '对方账号');
...
{ 
  ...
  **/
  ...
  vtcp_log("%s,%d,startsp6253",__FILE__,__LINE__);
  ...
  if( cCk_flag[0] == '1' )  /*存款确认*/
  {
     ...
     iRet=Chnl_single_acct_Sel(g_pub_tx.reply,&sChnl_single_acct,"pt_date=%ld and pt_trace_no='%s' and sts='1'",lPt_old_date,cPt_old_trace);
     if( iRet == 0)
     {
          /*已经记账成功*/
          ...
          */
          ...
          set_zd_long("0040",sChnl_single_acct.trace_no);
          set_zd_long("0460",sChnl_single_acct.tx_date);
          goto ErrExit;
     }
  }
  zip_space(cAc_no);
  ...
  {/**** 否则是科目  **/
   ...
   /**　登记单笔记账登记薄　***/
   sChnl_single_acct.chnl_type[0] = cCtrlcmd[9]; /* 20120915 zws 增加渠道标志 */
   vtcp_log("[%s][%d],渠道标识=[%s]",__FILE__,__LINE__,sChnl_single_acct.chnl_type);
   
   sChnl_single_acct.tx_date = g_pub_tx.tx_date; /** 系统日期  **/
   sprintf(sChnl_single_acct.tx_time,"%6ld", g_pub_tx.tx_time);  /** 系统时间  **/
   sChnl_single_acct.trace_no=g_pub_tx.trace_no;
   memcpy(sChnl_single_acct.cur_no,"01",2); /**  暂时写死为01人民币 ***/
   memcpy(sChnl_single_acct.ac_no, g_pub_tx.ac_no,sizeof( sChnl_single_acct.ac_no)-1); /** 主账号 **/
   ...
   sChnl_single_acct.fee_amt = dFee_amt1 ;  /** 手续费 **/
   vtcp_log("[%s][%d],手续费=[%.2f]",__FILE__,__LINE__,dFee_amt1);
   sChnl_single_acct.ct_ind[0] = '1';  /** 现转标志  本交易只处理现金 **/
