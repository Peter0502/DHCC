...
{    
	...
	get_zd_data("1081",g_pub_tx.ac_no);		/* 卡/帐号 */
	get_zd_int("1082",&g_pub_tx.ac_seqn);		/* 序号 */	
	get_zd_double("1088",&g_pub_tx.tx_amt1);	/* 发放金额 */
