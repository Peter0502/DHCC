...
/*************************  全局变量定义 *******************/
char	g_sell_way[2];		/* 凭证注销方式 0零星，1整本*/
...
WRITEMSG
	...
	/*** Add By Azz ***/
	ret = pub_base_disac_file(  g_pub_tx.ac_no, g_mdm_ac_rel.ac_seqn, \
								g_pub_tx.ac_type );
	if( ret )
	{
...
static int init_pub_tx( )
{
	...
	get_zd_data( "0670", g_sell_way );		/* 作废方式 */
