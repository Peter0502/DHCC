...
/*
	strcpy( filename , "BMdezjzqbb" );	
	strcpy( vpfm, "dezjzqbb" );
*/
	strcpy( filename , "RPT987");
	strcpy( vpfm, "RPT987");
	...
	ret = Trace_log_rz_Dec_Sel( g_pub_tx.reply, "tx_date>=%ld and tx_date<=%ld and cur_no='01' and add_ind='0' and amt>%lf ORDER BY tx_br_no,tx_date,ct_ind,ac_no",tmp_date,g_pub_tx.tx_date,AMT_LMT );
	ERR_DEAL
