...
/*		case 'Y':  汇总 
		...
		case 'K': /* 年初借余额 */
			...
			if( flag==0 )
			{
				ret = sql_sum_double( "gl_sub","ydr_bal",&tmp_amt,"acc_hrt[1]='%c' and br_no='%s' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) ", acc_type[0],s_gl_sub.br_no );
			 /* if( acc_type[0]=='4' )
			  {
			...
			{
				ret = sql_sum_double( "gl_sub","ydr_bal",&tmp_amt,"acc_hrt[1]>='1' and br_no='%s' and acc_hrt[1]<='5' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) ",s_gl_sub.br_no );
			/*  ret = sql_sum_double( "gl_sub","ydr_bal",&tmp_amt1,"acc_hrt='40602' and br_no='%s' ",s_gl_sub.br_no);
				tmp_amt+=tmp_amt1;*/
			}
			ERR_DEAL
		...
		case 'L': /* 年初贷余额 */
			if( flag==0 )
			{
				ret = sql_sum_double( "gl_sub","ycr_bal",&tmp_amt,"acc_hrt[1]='%c' and br_no='%s' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) ", acc_type[0] ,s_gl_sub.br_no);
			  /*if(acc_type[0]=='4')
			  {
			...
			{
				ret = sql_sum_double( "gl_sub","ycr_bal",&tmp_amt,"acc_hrt[1]>='1' and br_no='%s' and acc_hrt[1]<='5' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) " ,s_gl_sub.br_no);
			/*  ret = sql_sum_double( "gl_sub","ycr_bal",&tmp_amt1,"acc_hrt='40601' and br_no='%s' ",s_gl_sub.br_no);
				tmp_amt+=tmp_amt1;*/
			}
			ERR_DEAL
		...
		case 'O': /* 本年借发生额 */
			if( flag==0  )
			{
				ret = sql_sum_double( "gl_sub","ydr_amt",&tmp_amt,"acc_hrt[1]='%c'  and br_no='%s' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) ", acc_type[0],s_gl_sub.br_no );
			}
			else
			{
				ret = sql_sum_double( "gl_sub","ydr_amt",&tmp_amt,"acc_hrt[1]>='1' and br_no='%s' and acc_hrt[1]<='5' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) ",s_gl_sub.br_no );
			}
			ERR_DEAL
		...
		case 'P': /* 本年贷发生额 */
			if( flag==0 )
			{
				ret = sql_sum_double( "gl_sub","ycr_amt",&tmp_amt,"acc_hrt[1]='%c' and br_no='%s' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' )", acc_type[0] ,s_gl_sub.br_no);
			}
			else
			{
				ret = sql_sum_double( "gl_sub","ycr_amt",&tmp_amt,"acc_hrt[1]>='1' and br_no='%s' and acc_hrt[1]<='5' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) ",s_gl_sub.br_no );
			}
			ERR_DEAL
		...
		case 'V': /* 年末贷余额 */
			if( flag==0 )
			{
				ret = sql_sum_double( "gl_sub","cr_bal",&tmp_amt,"acc_hrt[1]='%c' and br_no='%s' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' )", acc_type[0],s_gl_sub.br_no );
			 /* if(acc_type[0]=='4')
			  {
			...
			{
				ret = sql_sum_double( "gl_sub","cr_bal",&tmp_amt,"acc_hrt[1]>='1' and br_no='%s' and acc_hrt[1]<='5' and acc_hrt in ( select acc_hrt from com_item where acc_lvl[1]='1' ) " ,s_gl_sub.br_no);
			/*  ret = sql_sum_double( "gl_sub","cr_bal",&tmp_amt1,"acc_hrt='40601' and br_no='%s' ",s_gl_sub.br_no);
				tmp_amt+=tmp_amt1;*/
			}
			ERR_DEAL
			...
			break;
			case 'Y': /* 年初余额 */
				sprintf( amt_tmp, "%.2lf" , s_gl_sub.ydr_bal+s_gl_sub.ycr_bal ); 
