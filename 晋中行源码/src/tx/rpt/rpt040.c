...
int get_ratio_lnjxkkqd(int bli,int bll,char str[100]);
...
rpt040()
{
	...
	pub_base_sysinit();
/*	
	strcpy( filename , "BJlnjxkkqd" );	
	strcpy(vpfm, "lnjxkkqd" );
*/	
	strcpy( filename , "RPT040");
	strcpy(vpfm, "RPT040");
	/* 本金积数结息清单 */
...
{	
	ret = pub_rpt_read_pfm_qd(fp,&line,vpfm,"0001",vrec,&opncnt,get_ratio_lnjxkkqd);
	ERR_DEAL
...
/* 赋值函数 */
int get_ratio_lnjxkkqd( bli,bll,str )
int bli,bll;
char str[100];
{ 
	char vhm[101]; 
