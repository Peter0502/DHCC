/*************************************************************
* ÎÄ ¼þ Ãû: rpt99T.c
* ¹¦ÄÜÃèÊö£ºÈÕÖÕÌØ±ð¶àµÄ´«Æ±´òÓ¡
*
* ×÷    Õß: rob
* Íê³ÉÈÕÆÚ: 2003Äê09ÔÂ20ÈÕ
*
* ÐÞ¸Ä¼ÇÂ¼£º
* ÈÕ    ÆÚ:
* ÐÞ ¸Ä ÈË:
...
OkExit:
	...
	sprintf(acErrMsg,"ÈÕÖÕÌØ±ð¶àµÄ´«Æ±Í³¼ÆÊý¾Ý´¦Àí³ÌÐò³É¹¦!!!!![%s]",g_pub_tx.reply);
	WRITEMSG
	set_zd_data("0120",g_pub_tx.reply);
	return 0;
ErrExit:
	sql_rollback();	/*--ÊÂÎñ»Ø¹ö--*/
	sprintf(acErrMsg,"ÈÕÖÕÌØ±ð¶àµÄ´«Æ±Í³¼ÆÊý¾Ý´¦Àí³ÌÐòÊ§°Ü!!!!![%s]",g_pub_tx.reply);
	WRITEMSG
	set_zd_data("0120",g_pub_tx.reply);
	return 1;
}
