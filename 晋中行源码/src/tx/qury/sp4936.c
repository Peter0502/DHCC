...
int sp4936()
{
	...
	get_zd_data("0380",f_mo_discnt.tpact_no );
	...
	/**组成查询条件**/
	pub_base_strpack( f_mo_discnt.tpact_no );
	if( strlen(f_mo_discnt.tpact_no) )
	{
		sprintf( tmpstr," tpact_no='%s' and",f_mo_discnt.tpact_no );
	...
	strcat( wherelist, " pn_type in ('4','5') and " );
	...
	strcpy( fieldlist,"tpact_no,ac_id,ac_seqn,br_no,bkrl_code,pn_type,tranx_bal,pn_rate,pn_date,local_ind,pn_int,pn_name,pay_ac_type,get_ac_type,tpay_ac_type,remitter,rem_ac_no,payer_brno_name,payee,payee_ac_no,payee_brno_name,par_amt,not_matr_date,note_type,pnote_no,way_days,wrk_date,trace_no,sts");
