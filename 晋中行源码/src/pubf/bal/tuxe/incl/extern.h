...
extern long         sub_serv;              /* tpsubscribe         */
...
#ifdef FOR_APCTL
extern short   cs83_mvmacta();
extern short   cs81_mvtota();
extern int    cs18_putmsg( char *, int *, char*);
...
extern int 		bal_conv_out( T_BTR*, int*, T_BTR**);
...
extern int             bal_callback_reply(T_BTR*, int);
extern int             bal_is_callback_reply();
...
extern short 	request_nowait(char*, char*, char*, short, long*);
extern short  	request_wait(char*, char*, short, short, char**, short*);
extern void     bal_return_error(T_BTR*);
