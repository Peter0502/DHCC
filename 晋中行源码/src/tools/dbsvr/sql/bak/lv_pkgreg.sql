...
create table lv_pkgreg(
  ...
  tx_time         varchar2(14),/*交易时间yyyymmddhhmmss，保存第一次*/
  ...
  brprtflag       varchar2(3) ,/*支行打印标志      */
  qsprtflag       varchar2(3) ,/*清算中心打印标志  */
...
create unique index lv_pkgreg_idx on lv_pkgreg(or_br_no,wt_date,orderno)  tablespace indx;
