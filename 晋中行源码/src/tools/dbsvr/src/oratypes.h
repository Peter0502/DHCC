...
#define UB8MAXVAL    ((ub8)18446744073709551615uLL)

#define MAXUB8MINVAL ((ub8)0)
#define MINUB8MAXVAL ((ub8)18446744073709551615uLL)
...
#define SB8MINVAL    ((sb8)-9223372036854775808LL)
#define SB8MAXVAL    ((sb8) 9223372036854775807LL)

#define MAXSB8MINVAL ((sb8)-9223372036854775807LL)
#define MINSB8MAXVAL ((sb8) 9223372036854775807LL)
