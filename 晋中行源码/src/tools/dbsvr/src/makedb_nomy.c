...
int makedb_tab(char *pcTabName)
{
	...
	sprintf(pcFileName,"%s/dbsrc/%s_nomy.pc",getenv("DBSDIR"),pcTabName);
	...
	fprintf(fp,"/****                              查询函数部分                           ****/\n");
	fprintf(fp,"/*****************************************************************************/\n");
	fprintf(fp,"int %s_Sel1(reply,%s_c,fmtstr,va_alist)\n",pcTabName2,pcTabName);
	...
	fprintf(fp,"\n");
	fprintf(fp,"	ret = %s_Dec_Sel1( reply , \"%s\" , wherelist );\n",pcTabName2, "%s");
	fprintf(fp,"	if (ret){\n");
	fprintf(fp,"		WRITEMSG\n");
	fprintf(fp,"		return ret;\n");
	fprintf(fp,"	}\n");
	fprintf(fp,"	ret = %s_Fet_Sel1( %s_c , reply );\n",pcTabName2,pcTabName);
	fprintf(fp,"	if (ret){\n");
	fprintf(fp,"		WRITEMSG\n");
	fprintf(fp,"		return ret;\n");
	fprintf(fp,"	}\n");
	fprintf(fp,"\n");
	fprintf(fp,"	%s_Clo_Sel1();\n",pcTabName2);
	fprintf(fp,"\n");
	fprintf(fp,"	return 0;\n");
	fprintf(fp,"}\n");
	fprintf(fp,"\n");
	...
	fprintf(fp,"int %s_Dec_Sel1 ( reply , fmtstr , va_alist )\n",pcTabName2);
	fprintf(fp,"char    *reply;\n");
	fprintf(fp,"char    *fmtstr;\n");
	fprintf(fp,"va_dcl\n");
	fprintf(fp,"{\n");
	...
	fprintf(fp,"}\n");
	fprintf(fp,"\n");
	fprintf(fp,"int %s_Fet_Sel1 ( struct %s_c *%s_c , char * reply )\n",pcTabName2,pcTabName,pcTabName);
	fprintf(fp,"{\n");
	fprintf(fp,"\n");
	fprintf(fp,"	int   ret;\n");
	fprintf(fp,"\n");
	...
	fprintf(fp,"/****                              修改函数部分                           ****/\n");
	fprintf(fp,"/*****************************************************************************/\n");
	fprintf(fp,"int %s_Dec_Upd1( reply , fmtstr , va_alist)\n",pcTabName2);
	fprintf(fp,"char    *reply;\n");
	fprintf(fp,"char    *fmtstr;\n");
	fprintf(fp,"va_dcl\n");
	fprintf(fp,"{\n");
	...
	fprintf(fp,"}\n");
	fprintf(fp,"\n");
	fprintf(fp,"int %s_Fet_Upd1( struct %s_c *%s_c , char * reply ){\n",pcTabName2,pcTabName,pcTabName);
	fprintf(fp,"	int   ret;\n");
	fprintf(fp,"\n");
	...
	fprintf(fp,"}\n");
	fprintf(fp,"\n");
	fprintf(fp,"int %s_Upd_Upd1( struct %s_c %s_c , char * reply){\n",pcTabName2,pcTabName,pcTabName);
	fprintf(fp,"	int ret;\n");
	fprintf(fp,"\n");
	...
	fprintf(fp,"\n");
	fprintf(fp,"\n");
	fprintf(fp,"int %s_Del_Upd1(struct %s_c %s_c , char * reply  ){\n",pcTabName2,pcTabName,pcTabName);
	fprintf(fp,"\n");
	...
	fprintf(fp,"/****                              增加函数部分                           ****/\n");
	fprintf(fp,"/*****************************************************************************/\n");
	fprintf(fp,"int %s_Ins1( struct %s_c %s_c , char * reply ){\n",pcTabName2,pcTabName,pcTabName);
	fprintf(fp,"	int ret;\n");
	fprintf(fp,"\n");
...
int main(){
	...
	FILE *fp;
	char line[1024];
	sprintf(pcFileName,"%s/etc/table_name_nomy",getenv("DBSDIR"),TABNDIR);
